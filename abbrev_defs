...
(define-abbrev-table 'global-abbrev-table
  '(
    ...
    ("lpqq" "{-# LANGUAGE QuasiQuotes #-}" nil 7)
    ("lprag" "{-# LANGUAGE  #-}" nil 8)
    ("pd" "print STDERR Dumper('☺');" nil 6)
    ("pdd" "aowdakdiwd" nil 2)
    ("sub" "sub name { my ( $args ) = @_; return 1;}" nil 2)
    ("udd" "use Data::Dumper;" nil 3)
   ))
...
(define-abbrev-table 'perlcritic-error-mode-abbrev-table '())
